        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left min-w-0 order-2 lg:order-1">
            ...
            {(siteContent.facebook || siteContent.instagram || siteContent.youtube) && (
              <div className="flex items-center justify-center lg:justify-start gap-3 mt-3 flex-wrap">
                <span className="font-body text-[11px] text-brand-muted/40">Follow us:</span>
                {siteContent.facebook && (
                  <a
                    href={siteContent.facebook}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="font-heading text-[10px] uppercase tracking-widest text-brand-muted/50 hover:text-brand-red transition-colors flex items-center gap-1.5"
                  >

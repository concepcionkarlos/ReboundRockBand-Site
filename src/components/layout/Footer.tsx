  ...
  return (
    <footer className="bg-brand-surface border-t border-brand-border">
      <div className="max-w-7xl mx-auto px-5 lg:px-10 py-14 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        {/* Contact */}
        <div>
          <h4 className="font-heading text-xs uppercase tracking-widest text-brand-red mb-5">Book Rebound Rock Band</h4>
          ...
          <a
            ...
            className="font-body text-sm text-white hover:text-brand-red transition-colors block mb-2 break-all"
          >
            {siteContent.contactEmail}
          </a>
          <a
            href={`tel:${siteContent.contactPhone}`}
            className="font-body text-sm text-brand-muted hover:text-white transition-colors block"
          >
            {siteContent.contactPhone}
          </a>
          <p className="font-body text-xs text-brand-muted/60 mt-5">Based in South Florida</p>
        </div>
      </div>
      ...
      <div className="border-t border-brand-border">
        <div className="max-w-7xl mx-auto px-5 lg:px-10 h-12 flex items-center justify-between gap-4">
          ...
          <Link href="/admin" className="font-body text-xs text-brand-muted/30 hover:text-brand-muted transition-colors">
            Admin
          </Link>
        </div>
      </div>
